  ...
  try:
    ...
    if not nomes_titulos_geral:
      ...
      if ocorrencia_escolhida != "Escolha a Ocorrência...":
        ...
        with st.spinner(
            "Calculando as médias gerais proporcionais de todas as regiões..."
        ):
          dados_comparativos = []
            ...
            try:
              ...
              if idx_titulo != -1 and idx_titulo + 2 < len(df_b):
                ...
                for c_idx in range(df_b.shape[1]):
                  c_name = str(df_b.iloc[idx_titulo + 1, c_idx]).lower()
                ...
                if col_caso is not None and not df_sub.empty:
                  ...
                  if taxas_anuais:
                    ...
                    dados_comparativos.append({
                        ...
                        "Média da Taxa por 1.000 Hab.": round(media_taxa, 2),
                    })
            except Exception:
              continue
          ...
          if dados_comparativos:
            ...
            st.warning(
                "⚠️ Não foram encontrados dados suficientes para esta ocorrência"
                " em todas as regiões."
            )
      else:
        st.info(
